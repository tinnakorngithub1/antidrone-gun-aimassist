...
- คืน (pan_deg, tilt_deg) จากตำแหน่ง pixel บน output frame ด้วย bilinear interpolation
...
def pixel_to_arm_degrees(
    ...
    ถ้า use_homography และมี homography ใช้ matrix ก่อน; ไม่มีหรือผิดพลาด fallback ไป bilinear grid.
