...
LOCK_SIM_TARGET_RANGE_M = 150.0       # ระยะโดรน (m) — โจทย์จริง 100–200m (โดรนจะเล็กมาก)
...
CAM4_ARM_RUN_SELFTEST_ON_CONNECT = True
...
CAM4_ARM_LIVENESS_GRBL_TIMEOUT_SEC = 1.5
CAM4_ARM_LIVENESS_FAILS_BEFORE_DISC = 2
...
CAM4_ARM_HOMING_IDLE_TIMEOUT_SEC = 60.0
