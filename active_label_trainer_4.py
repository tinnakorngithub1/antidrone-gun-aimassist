...
class ActiveLabelTrainer:
    FEATURE_DIM = 16
    FEATURE_NAMES = [
        "vel_mag_per_sec",       # f0: mean speed (normalized/sec) — replaces per-frame vel_mag_norm
        "acc_mag_per_sec",       # f1: mean acceleration (normalized/sec^2) — replaces per-frame acc_mag_norm
        "smoothness_index",      # f2
        "area_variance",         # f3
        "bbox_area_norm",        # f4
        "avg_area_norm",         # f5
        ...
        "hover_ratio",           # f13: threshold now in norm/sec units
