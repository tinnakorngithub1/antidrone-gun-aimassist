...
def main():
    ...
    try:
        while True:
            ...
            cv2.putText(frame, lag_text, (w - lag_tw - 28, 70), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), 2)
            ...
            if pipeline_latency_history:
                ...
                cv2.putText(frame, lat_text, (w - lt_tw - 28, 98), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), 2)
            ...
            cv2.putText(frame, conf_text, (w - conf_tw - 28, 126), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 0), 2)
